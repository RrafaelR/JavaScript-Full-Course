...
// 4. Bonus2: Minimum score also applies to a draw! So a draw only happens when both teams have the same score and both have 
...
if(DolphinsScore>KoalasScore && DolphinsScore>=100)
    ...
    console.log("We have draw! Both team win the trophy!");
else
